...
- "what ultimately matters in this course is not so much where you end up relative to your classmates but where you, in *week 11*, end up relative to yourself in *week 0*"
  ...
  - Keep in mind students' previous CS comfortably.
    - At the begging of the year, students self-select if they are More Comfortable, Less Comfortable, or somewhere in the middle.
...
- fifteen
  - Introduction to working with distribution code.
    - Helpful for having student practice reading other people's code, a common practice in industry.
...
- CS50 Hackathon
  ...
  - On campus at Harvard, it occurs at the end of the semester as a 12-hour event to work on final projects.
    ...
    - Trip to IHOP at 5am.
  - At High schools
    - Mid-Semester to bring students together to get them reengaged.
- CS50 Fair
...
- There is less of the teaching support structure
  - Harvard has between 80-100 undergraduates who work as teaching fellows.
...
- Then, David showcases some drawings from the audience to show how varied they look. Mentioning that Patti utilized low-level language and highlights the importance of abstraction to convey ideas.
